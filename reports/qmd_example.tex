...
Timbers (Timbers 2020).}

\section{Results}\label{results}

!{[}Horse populations for all provinces in Canada from 1906 -
1972.{]}\pandocbounded{\includegraphics[keepaspectratio]{results/horse_pops_plot.png}}

We can see from \textbf{?@fig-horse-pops} that Ontario, Saskatchewan and
...
time period visualised in \textbf{?@fig-horse-pops} to further support
this hypothesis.
...
span as \textbf{?@fig-horse-pops}.

!{[}Horse populations for the province with the largest standard
deviation.{]}\pandocbounded{\includegraphics[keepaspectratio]{results/horse_pops_plot_largest_sd.png}}

In \textbf{?@fig-largest-sd} we zoom in and look at the province of
Saskatchewan, which had the largest spread.
